...
# Tạo các nhãn mô tả
description_label = ttk.Label(app, text="Chọn một chức năng để bắt đầu:", wraplength=400)
...
limit_button = tk.Button(button_frame, text="Tính Giới Hạn", command=open_limit_window)
limit_button.pack(side=tk.LEFT)

derivative_button = tk.Button(button_frame, text="Tính Đạo Hàm", command=open_derivative_window)
derivative_button.pack(side=tk.LEFT)

integral_button = tk.Button(button_frame, text="Tính nguyên hàm", command=open_integral_window)
integral_button.pack(side=tk.LEFT)

division_button = tk.Button(button_frame, text="Chia Đa Thức", command=open_polynomial_division_window)
division_button.pack(side=tk.LEFT)
